...
2. CLI: Benchmark The Performance of a Model
3. Jupyter Notebook: ML Suite Caffe Flow End2End w/ MNIST Dataset
4. CLI: Real Application - Face Detection in Xilinx FPGAs on AWS
